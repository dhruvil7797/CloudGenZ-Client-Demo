...
document.querySelectorAll('.ic-num').forEach(el => co.observe(el));
document.querySelector('.nl-form')?.addEventListener('submit', e => { e.preventDefault(); const b=e.target.querySelector('button'); b.textContent='✓ Subscribed!'; });
