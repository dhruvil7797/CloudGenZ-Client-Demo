...
window.addEventListener('scroll',()=>nav.style.boxShadow=window.scrollY>40?'0 4px 20px rgba(0,0,0,0.3)':'none');
...
let a=50;const dbs=document.querySelectorAll('.da-b'),di=document.getElementById('dAmt'),db=document.getElementById('dBtn');
...
db.addEventListener('click',()=>alert(`Thank you for donating $${a}! Redirecting...`));
